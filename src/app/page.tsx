...
import { decodeHamming, encodeHamming } from "../utils/hamming";
...
export default function Home() {
  ...
  const simulate = () => {
    ...
    setTimeout(() => {
      ...
      const encodedBlocks = blocks
        .map((b) => (useHamming ? encodeHamming(b) : b))
        .join("");
      ...
      const correctedBlocks = (noisy.match(/.{1,12}/g) || []).map((b) =>
        useHamming ? decodeHamming(b).corrected : b
      );
      ...
      <div className="flex flex-col space-y-6">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-2">
            Simulate data transmission with different encoding schemes and error
            correction
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="md:col-span-2">
            <CardHeader>
              ...
              <CardDescription>
                View the transmission process and &quot;results&quot;
              </CardDescription>
            </CardHeader>
            <CardContent>
              {!result ? (
                <div className="flex flex-col items-center justify-center py-12 text-center text-muted-foreground">
                  <p>
                    Enter text and click &quot;Simulate Transmission&quot; to
                    see results
                  </p>
                </div>
              ) : (
